...
class User(commands.Cog):
    ...
    @commands.command(aliases=["av"], name="avatar", description="Get the avatar of user.")
    @commands.guild_only()
    ...
    @commands.command(name="roles", description="Get all roles in server.")
    @commands.guild_only()
    ...
    @commands.command(aliases=["joindate", "joinedat"], name="joined", description="Check when a user joined the server.")
    @commands.guild_only()
    ...
    @commands.command(name="mods", description="Check which mods are online in server.")
    @commands.guild_only()
    ...
    @commands.group(name="server", description="Check info about the server.")
    @commands.guild_only()
    ...
    @server.command(aliases=["icon"], name="avatar", description="Get the current server icon.")
    @commands.guild_only()
    async def server_avatar(self, ctx):
        ...
        await ctx.send(f"🖼 Icon of **{ctx.guild.name}**", embed=embed)

    @server.command(name="banner", description="Get the server banner image.")
    ...
    @commands.command(name="user", description="Get user information.")
    @commands.guild_only()
